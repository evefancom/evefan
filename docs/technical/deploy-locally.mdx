---
title: Run locally
description: Easily test your new integrations by running OpenInt locally
---

While implementing your new OpenInt pipeline, you may want to run locally
to test your changes.

Note: we welcome [pull requests](https://github.com/openintegrations/openint)!

## Localhost Quickstart

1. Clone repo `git clone git@github.com:openintegrations/openint.git`

2. Make a copy of the [.env.example](https://github.com/openintegrations/openint/blob/main/.env.example) file named `.env`
...
```bash
pnpm run migration up # (optional) we support Postgres for now, but feel free to extend OpenInt and add more
```
