...
OpenInt tries to be as clear and consistent as possible with the nomenclature
...
| :-------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------- | ------------------------ |
| <strong>Organization</strong>     | An isolated OpenInt workspace with its own `Connector Config`s, `End User`'s and `User`s                                                                                                                                                                                                                                                                                                                            | <ul><li>`Your Company Dev`</li><li>`Your Company Prod`</li></ul>                                                              | Developer (You)          |
| <strong>User</strong>             | A developer using OpenInt to deliver great experiences! May belong to multiple `Organization`s.                                                                                                                                                                                                                                                                                                                     | <ul><li>`dev@yourcompany.com`</li></ul>                                                                                       | Developer (You)          |
...
| <strong>Provider</strong>         | A product or service that your customers use (e.g. **Chase**, **Quickbooks**). This is a concept we may reference in docs / user interface but does not yet exist as an actual entity in the OpenInt API / Database.                                                                                                                                                                                                | <ul><li>`Chase`</li><li>`Quickbooks`</li><li>`Notion`</li></ul>                                                               | N/A                      |
| <strong>Connector</strong>        | Source code adhering to the <string>OpenInt Protocol</string>, can be a direct connector (e.g. **Quickbooks**) which provides a single `Integration` or an aggregator connector (e.g. **Plaid**) that provides many `Integration`'s                                                                                                                                                                                 | <ul><li>`Plaid`</li><li>`Merge`</li><li>`Notion`</li></ul>                                                                    | OpenInt Repo             |
| <strong>Integration</strong>      | An integration represents a `Provider` supported by a `Connector`. There can be multiple integrations for a single provider if multiple connectors support the same provider (e.g. Merge and Railz both gives you the ability to connect to Quickbooks, in addition we have a direct Quickbooks connector for a total of 3 Quickbooks Integrations).                                                                | <ul><li>`Plaid`'s integration with `Chase`</li><li>OpenInt Direct integration with `Notion`</li></ul>                         | OpenInt Connector        |
...
Used in a sentence:
A <strong>Pipeline</strong> simply connects a data <strong>Resource</strong> to/from OpenInt which transmits data across the <strong>OpenInt</strong> protocol.
